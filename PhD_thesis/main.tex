...
\frontmatter
\include{chapter_0/declaration}
\include{chapter_0/abstract}
\include{chapter_0/dedication}
\include{chapter_0/acknowledgements}
%\newpage
%\thispagestyle{empty}
%\mbox{}
\include{chapter_0/publications}
...
\include{chapter_2/observing}
\include{chapter_3/DR2_search}
\include{chapter_4/pre-ZTF_search}
\include{chapter_5/real-time_search}
\include{chapter_6/Conclusion_and_future}
% --------------------------------------------------------------
%:                  BACK MATTER: appendices, refs,..
% --------------------------------------------------------------

%: ------------------- paper acknowedgements -------------------
\include{chapter_0/final_acknowledgements}
%: ----------------------- bibliography ------------------------
