...
%\color{red} This is Paper I, but needs to be properly adapted. Copied in paper and put the appendices in the proper text part. To-do list: Check for broken references, reformat pages, make sure all the \ztfg\ztfr\ztfi\ things are consistent\color{black}
